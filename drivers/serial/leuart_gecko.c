...
static const struct leuart_gecko_config leuart_gecko_0_config = {
	.base = (LEUART_TypeDef *)CONFIG_LEUART_GECKO_0_BASE_ADDRESS,
	.clock = cmuClock_LEUART0,
	.baud_rate = CONFIG_LEUART_GECKO_0_CURRENT_SPEED,
	.pin_rx = PIN_LEUART0_RXD,
	.pin_tx = PIN_LEUART0_TXD,
	.loc = CONFIG_LEUART_GECKO_0_LOCATION,
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
DEVICE_AND_API_INIT(leuart_0, CONFIG_LEUART_GECKO_0_LABEL, &leuart_gecko_init,
...
static void leuart_gecko_config_func_0(struct device *dev)
{
	IRQ_CONNECT(CONFIG_LEUART_GECKO_0_IRQ,
		    CONFIG_LEUART_GECKO_0_IRQ_PRIORITY, leuart_gecko_isr,
		    DEVICE_GET(leuart_0), 0);

	irq_enable(CONFIG_LEUART_GECKO_0_IRQ);
}
#endif
