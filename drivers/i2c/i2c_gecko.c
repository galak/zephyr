...
static void i2c_gecko_config_func_0(struct device *dev)
{
	...
	IRQ_CONNECT(CONFIG_I2C_GECKO_0_IRQ, CONFIG_I2C_GECKO_0_IRQ_PRIORITY,
			i2c_gecko_isr, DEVICE_GET(i2c_gecko_0), 0);

	irq_enable(CONFIG_I2C_GECKO_0_IRQ);
}
#endif /* CONFIG_I2C_0 */
...
static void i2c_gecko_config_func_1(struct device *dev)
{
	...
	IRQ_CONNECT(CONFIG_I2C_GECKO_1_IRQ, CONFIG_I2C_GECKO_1_IRQ_PRIORITY,
			i2c_gecko_isr, DEVICE_GET(i2c_gecko_1), 0);

	irq_enable(CONFIG_I2C_GECKO_1_IRQ);
}
#endif /* CONFIG_I2C_1 */
